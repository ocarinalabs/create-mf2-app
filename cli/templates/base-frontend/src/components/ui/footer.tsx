...
// CUSTOMIZE THIS: Ship fast. Add real links when you have them.
...
// CUSTOMIZE THIS: Add your real social links. Be where your users are.
...
export function Footer({
  ...
  copyright = `© ${new Date().getFullYear()} Your Product`,
}: FooterProps) {
